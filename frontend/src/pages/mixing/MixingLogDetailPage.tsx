...
export default function MixingLogDetailPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Visual Check */}
      <div className="card">
        <h2 className="text-lg font-semibold text-gray-800 mb-2"><Bi k="field.visualCheck" /></h2>
        <span className={`inline-block px-3 py-1 rounded-full text-sm font-medium ${log.visual_check ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
          {log.visual_check ? 'Yes' : 'No'}
        </span>
      </div>
