...
export default function Drawer({ open, title, subtitle, onClose, children, wide }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex items-start justify-between gap-4 p-4 border-b border-slate-200 sm:p-5">
          <div>
          ...
          <button
            type="button"
            className="-m-2 inline-flex h-11 w-11 items-center justify-center rounded-lg text-slate-400 hover:bg-slate-50 hover:text-slate-600"
            onClick={onClose}
            aria-label="關閉"
          >
