...
export const prodBatchesApi = {
  list: async (params?: {
    skip?: number; limit?: number; status?: string; date_from?: string; date_to?: string; product_type?: string; meat_state?: string; product_code?: string; include_voided?: boolean;
